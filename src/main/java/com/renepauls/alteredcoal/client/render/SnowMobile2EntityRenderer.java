...
public class SnowMobile2EntityRenderer extends MobRenderer<SnowMobileEntity, SnowMobile2EntityModel<SnowMobileEntity>> {
	...
	public SnowMobile2EntityRenderer(EntityRendererManager renderManagerIn) {
		super(renderManagerIn, new SnowMobile2EntityModel<SnowMobileEntity>(), 0.5f);
	}
